...
private:	
	...
	Cell transitions[25][9] = {
			...
			/*4*/{Cell(24, 'D', true), Cell(4, '1', true), Cell(24, '0', true), Cell(24, 'x', true), Cell(24, 'y', true), Cell(24, 'z', true), Cell(4, '#', true), Cell(4, '@', true), Cell(5, '0', false)},
			...
			/*11*/{Cell(24, 'D', true), Cell(24, '1', true), Cell(12, 'z', true), Cell(24, 'x', true), Cell(24, 'y', true), Cell(24, 'z', true), Cell(24, '#', true), Cell(24, '@', true), Cell(24, 'B', true)},
			...
			/*15*/{Cell(24, 'D', true), Cell(24, '1', true), Cell(24, '0', true), Cell(9, 'x', false), Cell(24, 'y', true), Cell(15, 'z', false), Cell(15, '#', false), Cell(15, '@', false), Cell(24, 'B', true)},
			...
			/*17*/{Cell(24, 'D', true), Cell(24, '1', true), Cell(24, '0', true), Cell(24, 'x', true), Cell(17, '1', true), Cell(24, 'z', true), Cell(18, '#', false), Cell(24, '@', true), Cell(24, 'B', true)},
			...
			/*23*/{Cell(24, 'D', true), Cell(23, '1', false), Cell(23, '0', false), Cell(24, 'x', true), Cell(23, 'y', false), Cell(24, 'z', true), Cell(24, '#', true), Cell(23, '@', false), Cell(24, 'B', true)},
			/*24*/{Cell(24, 'D', true), Cell(23, '1', false), Cell(23, '0', false), Cell(24, 'x', true), Cell(23, 'y', false), Cell(24, 'z', true), Cell(24, '#', true), Cell(23, '@', false), Cell(24, 'B', true)}
		};
public:
	TuringMachine(int x, int y) {				
		inputTape.push_back('D');
